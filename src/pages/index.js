...
import profilePic from "../../public/images/profile/Emmy.jpg";

export default function Home() {
  return (
    <>
      <Head>
        <title>Emmanuel Udorah - Portfolio</title>
        <meta
          name="description"
          ...
          <div className="flex w-full items-start justify-between md:flex-col pt-10 pb-24">
            ...
            <div className="flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <p className="my-4 text-base font-medium md:text-sm sm:!text-sm">
                Frontend Developer | React.js • Next.js • TypeScript • Tailwind CSS | Building Fast, 
                Scalable & User-Focused Web Applications | Open to Frontend Engineering Opportunities
              </p>
