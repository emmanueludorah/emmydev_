...
const Details = ({ degree, school, schoolLink, time, address, details }) => {
  ...
  return (
    <div className="my-64">
      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        <motion.div
          className="absolute left-9 top-0 w-[4px] md:w-[2px] md:left-[30px] xs:left-[20px] h-full bg-primaryDark shadow-3xl origin-top dark:bg-primaryDark dark:shadow-3xl"
